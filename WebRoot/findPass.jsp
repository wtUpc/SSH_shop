...
<input name="搜索" type="submit" value="搜索" />
  ...
  <tr ><td  colspan=3  bgcolor="#c0c0c0" align="center" ><h3>请输入您注册时的信息</h3></td> 
    ...
    <tr> 
      ...
      <td width=100> 
       ...
       <td width=180> 
        <div  id=msg3 style="color:#ff0000;display:none;">请输入您的姓名</div>
      </td>
    </tr>
    <tr> 
      <td height=30>性别:</td>
    ...
    <td height=30>用户电话:</td>
      <td width=100> 
       ...
       <td width=180> 
        <div  id=msg4 style="color:#ff0000;display:none;">请输入您的真实电话</div>
      </td>
    </tr>
    <tr>
    <td height=30>邮编:</td>
      <td width=100> 
       ...
       <td width=180> 
        <div  id=msg7 style="color:#ff0000;display:none;">请输入您的准确邮编</div>
      </td>
    </tr>
    <tr>
    <td height=30>收货地址:</td>
      <td width=100> 
       ...
       <td width=180> 
        <div  id=msg5 style="color:#ff0000;display:none;">请输入您的准确收货地址</div>
      </td>
    </tr>
    <tr> 
      ...
      <td width=180> 
        <div  id=msg6 style="color:#ff0000;display:none;">填写如1111111@zzuli.com的地址</div>
      </td>
    </tr>
