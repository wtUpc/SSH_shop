...
<div id="main_container">
  <div class="top_bar"></div>
   ...
   <div id="main_content"> 
    ...
    导航: <span class="current"><a href="GoIndexAction.action">首页</a>&gt;&gt;用户留言</span>
...
<input name="搜索" type="submit" value="搜索" />
  ...
  <table width=100%>
  <tr><th align="center" colspan="2"><h2>留言板</h2></th></tr>
  <tr><td width="150">用户名：</td><td><input type="text" name="peopleName" readonly="readonly" value="${sessionScope.user.username}"/></td></tr>
  <tr><td>输入您的留言标题：</td><td><input type="text" name="title"/></td></tr>
  <tr><td>输入您的留言：</td><td><textarea name="message" rows="10" cols="50" wrap="physical"></textarea></td></tr>
  <tr><td></td><td><input type="submit" value="提交信息" name="submit" style="height:30px;width:100px"/>
  <input type="button" value="查看留言板" name="look" style="height:30px;width:100px" onclick="window.location.href('messageShow.jsp')"/></td></tr>
   </table></form>
	</td>
