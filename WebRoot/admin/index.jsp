...
<HTML><HEAD><TITLE>校园网上购物系统后台管理</TITLE>
...
<UL>
  ...
  <UL>
    ...
    <LI><A href="CommodityClassAction!listCommodityClass.action" target=frmright>商品种类列表</A> </LI>
    <LI><A href="CommodityAction!adCommodity.action" target=frmright>商品录入</A> </LI>
    <LI><A href="CommodityAction!listCommodity.action" target=frmright>商品列表</A> </LI>
 </UL></DIV>
  ...
  href="#">订单管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="OrderFormAction!listOrderForm.action"  target=frmright>订单列表</A> </LI>
    <!--<LI><A href="include/order/orderQuery.jsp" 
  ...
  href="#">用户管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="UserAction!listUser.action" target=frmright>用户列表</A> </LI>
    <!--<LI><A href="include/user/userQuery.jsp" target=frmright>用户查询</A> </LI>-->
	</UL></DIV>
  <DIV class=menu_div><IMG style="VERTICAL-ALIGN: bottom" 
  src="images/menu01_right.gif"></DIV></LI>
  ...
  href="#">系统管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="include/admin/amend.jsp" target=frmright>修改登录密码</A> </LI>
    </UL></DIV>
  <DIV class=menu_div>
  <IMG style="VERTICAL-ALIGN: bottom"  src="images/menu01_right.gif"></DIV></LI>
  </UL>
</DIV></DIV></DIV>
<DIV style="BACKGROUND: #337abb;WIDTH:80%; HEIGHT: 24px"></DIV><!--导航部分结束-->
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed 
        ...
        <TR height=32>
          ...
          <TD background=images/bg2.gif><SPAN 
            style="FLOAT: left">校园网上购物系统后台管理</SPAN>
            <SPAN  id=dvbbsannounce style="FONT-WEIGHT: bold; FLOAT: left; WIDTH: 80%; COLOR: #c00">
            </SPAN></TD>
          <TD style="COLOR: #135294; TEXT-ALIGN: right" 
          background=images/bg2.gif>欢迎登陆：${sessionScope.admin.username}| <A 
            href="login.jsp" >后台首页</A> 
            | <A href="../index.jsp" target=_top>前台首页</A> | 
            <A  href="AdminAction!logout.action"  onclick="return confirm('确定要退出吗?')"  target=_top>退出 </A> </TD>
          ...
          <IFRAME    class=main_iframe id=frmright name="frmright"  src="syscome.htm" frameBorder=0  scrolling=yes></IFRAME>
