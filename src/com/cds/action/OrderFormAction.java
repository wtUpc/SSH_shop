...
import com.cds.action.*;

import com.cds.service.OrderFormService;
...
//要调用OrderFormService的方法，所以要声明,让spring把其实现类注入
	...
	public String queryOrderForm(){
		...
		OrderForm orderForm=this.service.queryOrderForm(orderFormId,username,submitTime,consignmentTime);
		Map request=(Map) ActionContext.getContext().get("request");
